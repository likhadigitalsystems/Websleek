  ...
  return (
    <footer className="bg-websleek-dark text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-8">
          <div className="lg:col-span-5">
            <Link
              ...
              className="inline-flex items-center gap-4 mb-5 group"
            >
              <img
              ...
              />
              <span className="flex flex-col border-l border-white/15 pl-4">
        ...
        <div className="mt-12 pt-8 border-t border-white/10 flex flex-col sm:flex-row justify-between gap-3 text-xs text-white/45">
